...
<div id="account-register-otp" class="container">
  <div class="row">
    <div id="content" class="col-sm-12">
      <div class="auth-container">
        ...
        @if(session('verified_success'))
          <div class="alert alert-success">{{ session('verified_success') }}</div>
        @endif

        @if(!($isVerified ?? false))
          <p>Time left: <strong id="otp-timer">02:30</strong></p>

          <form method="POST" action="{{ route('frontend.register.otp.verify') }}">
            @csrf
            ...
            <button id="otp-submit" type="submit">Submit</button>
          </form>
