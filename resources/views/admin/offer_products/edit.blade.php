                ...
                <div class="col-xl-12 box-margin height-card">
                    <div class="card card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h4 class="card-title">Edit Offer Product</h4>
                        ...
                        <form method="POST" action="{{ route('admin.offer-products.update', $offerProduct->id) }}">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="offer_id" class="form-control" required>
                                        ...
                                        @foreach(($offers ?? collect()) as $offer)
                                            <option value="{{ $offer->id }}" {{ (string) old('offer_id', $offerProduct->offer_id) === (string) $offer->id ? 'selected' : '' }}>
                                                {{ $offer->offer_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="products_id" class="form-control" required>
                                        ...
                                        @foreach(($products ?? collect()) as $product)
                                            <option value="{{ $product->id }}" {{ (string) old('products_id', $offerProduct->products_id) === (string) $product->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <select name="is_active" class="form-control" required>
                                        <option value="1" {{ old('is_active', (string) $offerProduct->is_active) == '1' ? 'selected' : '' }}>Active</option>
                                        <option value="0" {{ old('is_active', (string) $offerProduct->is_active) == '0' ? 'selected' : '' }}>Inactive</option>
                                    </select>
                                </div>
                            </div>
