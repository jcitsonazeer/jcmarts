                ...
                <div class="col-xl-12 box-margin height-card">
                    <div class="card card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h4 class="card-title">Add Promo Tile</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <form method="POST" action="{{ route('admin.promo-tiles.store') }}" enctype="multipart/form-data">
                                    @csrf
                                    @php
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            <label>Promo Image <span class="text-danger">*</span></label>
                                            <input type="file"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text"
                                                   ...
                                                   maxlength="150"
                                                   placeholder="e.g. Big Savings Weekend"
                                                   required>
                                            @error('promo_title')
                                                <span class="text-danger d-block">{{ $message }}</span>
                                            @enderror
