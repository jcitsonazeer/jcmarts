                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="offer_details_id" class="form-control">
                                                ...
                                                @foreach(($offers ?? collect()) as $offer)
                                                    <option value="{{ $offer->id }}" {{ (string) old('offer_details_id', $banner->offer_details_id) === (string) $offer->id ? 'selected' : '' }}>
                                                        {{ $offer->offer_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="sub_category_id" class="form-control">
                                                ...
                                                @foreach(($subCategories ?? collect()) as $subCategory)
                                                    <option value="{{ $subCategory->id }}" {{ (string) old('sub_category_id', $banner->sub_category_id) === (string) $subCategory->id ? 'selected' : '' }}>
